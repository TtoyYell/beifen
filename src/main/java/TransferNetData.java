...
public class TransferNetData {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sql = "SELECT fid ,\n" +
                ...
                "'报纸','电视') and fadtypes <> '' and fadtypes <> '其他' and fid = 4999  ";
        ...
        for (Map<String, Object> map : mapList) {
            ...
            String insertSql = " INSERT INTO \"public\".\"net_local_edition\" " +
                    " (\"created_time\", \"updated_time\", \"updated_by\", \"dispatch_status\", " +
                    "\"deal_style\", \"ignored\", \"deal_at\", \"assigned_by\", \"accepted_by\", " +
                    "\"assigned_at\", \"assigned_deadline\", \"deleted\", \"reviewed\", \"reviewed_by\", " +
                    "\"reviewed_at\", \"supervise\", \"deal_style2\", \"ad_title\", \"category_id\", " +
                    "\"type\", \"landing_icp\", \"start_page\", \"end_page\", \"origin\", " +
                    "\"channel_name\", \"channel_area\", \"channel_icp\", \"advertiser_name\", \"advertiser_area\", " +
                    "\"ad_content\", \"level\", \"laws\", \"ad_screenshot\", \"landing_screenshot\", " +
                    "\"index_screenshot\", \"clue\", \"file_path\", \"tag_ids\", \"sp_tag_ids\", " +
                    ...
                    "\"evidence\", \"timeout\", \"is_timeout\", \"is_delay\", \"action_status\", " +
                    "\"user_deadline\") " +
                    " VALUES ('"+map.get("创建时间")+"', '"+map.get("修改时间")+"', "+getUserIdByName(Str(map.get("最终修改人")))+", "+getDispatchStatus(Str(map.get("派发状态")))+"," +
                    ...
                    " '"+evidenceJson+"', NULL, 'f', NULL, 1, NULL);\n ";
            ...
            for (Map<String, Object> flow : flowList) {
                ...
                String insertFlowSql = " INSERT INTO \"public\".\"net_action_local\" ( " +
                        " \"created_time\"," +
                        " \"updated_time\"," +
                        " \"updated_by\"," +
                        " \"conn_id\"," +
